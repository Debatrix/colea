...
uicontrol('Style','Text','String','分析 (ms)','Position',[lft+12 top wit 27],'BackgroundColor',...
...
uicontrol('Style','Text','String','阶数, N','Position',[lft+12+2*wit top-10 wit 27],'BackgroundColor',...
	 [0 0 0],'ForeGroundColor','r');
...
top=top-inc;
uicontrol('Style','Text','String','比较:','Position',[lft-10 top-8 wit 27],'BackgroundColor',...
	 [0 0 0],'ForeGroundColor','r');
uicontrol('Style','pushb','String','光标处','Position',[lft-10+wit top wit+15 20],...
	'Callback','comptool(''cursor'')');
uicontrol('Style','pushb','String','整体','Position',[lft-10+2*wit+20 top wit+15 20],...
	'Callback','comptool(''overall'')');
uicontrol('Style','pushb','String','取消','Position',[lft-10+3*wit+40 top wit+15 20],...
	'Callback','delete(gcf)');
...
top=top-inc;
uicontrol('Style','pushb','String','倒谱','Position',[lft top wit+15 20],...
	'Callback','comptool(''cep'')');
top=top-inc;
uicontrol('Style','pushb','String','W-倒谱','Position',[lft top wit+15 20],...
