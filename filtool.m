...
top=top-inc;
uicontrol('Style','Text','String','顺序','Position',[3 top lft 20],'BackgroundColor',...
	 [0 0 0],'ForeGroundColor','y');
...
lft=lft+12;
top=top-inc;
uicontrol('Style','pushb','String','查看过滤器','Position',[lft-10 top wit+15 20],...
	'Callback','apfilter(''LPF'',''view'')');
top=top-inc;
uicontrol('Style','pushb','String','应用过滤器','Position',[lft-10 top wit+15 20],...
...
top=top-inc;
uicontrol('Style','pushb','String','查看过滤器','Position',[lft top wit+10 20],...
	'Callback','apfilter(''HPF'',''view'')');
top=top-inc;
uicontrol('Style','pushb','String','应用过滤器','Position',[lft top wit+15 20],...
...
uicontrol('Style','Text','String','高','Position',[lft top-inc wit-5 20],'BackgroundColor',...
	 [0 0 0],'ForeGroundColor','y');
uicontrol('Style','Text','String','顺序','Position',[lft top-2*inc wit-5 20],'BackgroundColor',...
	 [0 0 0],'ForeGroundColor','y');
lft=lft+wit-5+1;
...
top=top-inc;
uicontrol('Style','pushb','String','查看过滤器','Position',[lft-5 top wit+18 20],...
	'Callback','apfilter(''BPF'',''view'')');
top=top-inc;
uicontrol('Style','pushb','String','应用过滤器','Position',[lft-5 top wit+18 20],...
