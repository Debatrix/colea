...
uicontrol('Style','Frame','Position',[8 50 wit+20 tp+65-50],...
	'BackgroundColor','b');
uicontrol('Style','Text','String','编辑','Position',[9 tp+63 wit+18 22],...
	'ForegroundColor',[1 1 1],'BackgroundColor','b','HorizontalAlignment','Center');

top=top-inc;
uicontrol('Style','Pushb','String','添加标签','Position',[lft-10 top wit+15 20],...
	'Callback','label(''add'')');
top=top-inc;
uicontrol('Style','pushb','String','删除标签','Position',[lft-10 top wit+15 20],...
	'Callback','label(''delete'')');
top=top-inc;
uicontrol('Style','pushb','String','删除全部','Position',[lft-10 top wit+15 20],...
...
uicontrol('Style','Frame','String','编辑','Position',[lft-5 tp wit+25 70],...
	'BackgroundColor','b');
uicontrol('Style','Text','String','文件','Position',[lft-4 tp+65 wit+23 20],...
	'ForegroundColor',[1 1 1],'BackgroundColor','b','HorizontalAlignment','Center');
top=top-inc;
uicontrol('Style','pushb','String','保存标签','Position',[lft top wit+20 20],...
	'Callback','label(''save'')');
top=top-inc;
uicontrol('Style','pushb','String','载入标签','Position',[lft top wit+20 20],...
